...
print(f"Support Vectors: {svm_model.support_vectors_.tolist()}")
...
print(f"\nPrediction for Z(1.5, 1.8):")
print(f"  Decision value: {dec_val:.4f}")
print(f"  Predicted class: {pred}")

# مقایسه با حل دستی
print("\n" + "=" * 50)
print("Comparison with Manual Solution:")
print("=" * 50)
print(f"Manual: w = [0, 1], b = -1, Margin = 2.00")
print(f"Code:   w = [{w[0]:.2f}, {w[1]:.2f}], b = {b:.2f}, Margin = {2/np.linalg.norm(w):.2f}")
